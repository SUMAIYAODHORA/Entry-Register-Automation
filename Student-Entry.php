<?php
    ...
    $query=mysqli_query($con,"INSERT into tblvisitor(StudentName, MobileNumber, Address,  RoomNo, WhomtoMeet, Reason) value('$stuname','$contactnumber','$address', '$roomno', '$whomtomeet', '$reason')");

    if ($query){
        $msg=" Entry details has been added";
    } else {
...
<div class="wrapper">
    ...
    <?php $page='Student'; include 'includes/stsidebar.php'?>
