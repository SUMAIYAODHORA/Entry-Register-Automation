    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="dist/img/SE.jpg" class="img-square" alt="User Image">
        </div>
        <div class="pull-left info">
          <p><?php echo $name; ?></p>
          <a href="#"><i class="fa fa-square text-success"></i> Online</a>
        </div>
      </div>
      <!-- search form -->
      ...
      <!--  <li class="<?php if($page=='visitor-management') { echo 'active'; }?>">
          <a href="visitor-mgmt.php">
            <i class="fa fa-address-card"></i> <span>Student Entry List</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li> -->
