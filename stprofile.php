<?php
    ...
    $query=mysqli_query($con,"INSERT into tblvisitor(StudentName, MobileNumber, Address,  RoomNo) value('$stuname','$contactnumber','$address', '$roomno')");

    if ($query){
        $msg="Student entry details has been added";
    } else {
...
<head>
  ...
  <title>Late Entry Register</title>
...
<div class="wrapper">
    ...
    <?php $page='visitors'; include 'includes/stsidebar.php'?>
      ...
      <?php if($msg){ echo "<div class='alert alert-success alert-dismissible'>
        ...
        <div class="box box-default">
          ...
          <!-- /.box-header -->
                ...
                <div class="col-md-6">
                  ...
                  <!--<div class="form-group">
                    <label>Room Number</label>
                        <select class="form-control select2" name="roomno" onChange="getBuilding(this.value);" style="width: 100%;" required>
            ...
            <button type="submit" class="btn btn-block btn-primary btn-lg" name="submit">Submit Details</button>
            </div>
          </div>
          </form>
